...
$hasChairpersonVoted = isset($_SESSION['hasChairpersonVoted']) && $_SESSION['hasChairpersonVoted'] === true;

if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['vote'])) {
    if (!$hasChairpersonVoted) {
        // Get the selected nominee from the radio button
        $selectedNominee = $_POST['nominee'];

        // Prepare the INSERT statement
        $query = "INSERT INTO tbl_vote (vote_nominee, vote_position) VALUES (?, 'chairperson')";
        ...
        if ($stmt) {
            ...
            if ($result) {
                ...
                // Set $hasChairpersonVoted to true if the voting process is successful
                $hasChairpersonVoted = true;
                $_SESSION['hasChairpersonVoted'] = true;
