...
<body>
    <nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark" style="margin-bottom:20px;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Vote Secretary</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="column"><h5>Vote for Secretary</h5></div>
        </div>
        <?php
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                if ($result) {
                    ...
                    if (count($nominees) > 0) {
                        echo '<form method="post" action="insert_secretary_vote.php">';
